...
namespace ManualDesktopForm.Services
{
    public class MongoDbService : IMongoDbService
    {
        ...
        {
            _logger.LogInformation("Retrieving MongoDB collection: {CollectionName}", name);
            var database = _devicesCollection.Database; // Access the database from the existing collection
